...
class SprintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sprint" do
    assert_difference("Sprint.count") do
      post sprints_url, params: { sprint: { end_date: @sprint.end_date, start_date: @sprint.start_date } }
    end
  ...
  test "should update sprint" do
    patch sprint_url(@sprint), params: { sprint: { end_date: @sprint.end_date, start_date: @sprint.start_date } }
